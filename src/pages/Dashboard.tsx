...
import { getProfileProgress, getStudentApplications } from "@/services/studentProfile";
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        try {
          ...
          const totalSteps = progressData.total || 9;
          ...
          console.warn('Profile progress API error:', profileErr);
      ...
      <section>
        <div className="mb-4 sm:mb-6">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">
            {completedStepsCount} of {totalStepsCount} steps completed - You're {profileCompletion}% through your profile!
          </p>
        </div>
            ...
            {!isProfileComplete && (
              <div className="mt-4 p-3 bg-muted/50 rounded-lg">
                <p className="text-xs sm:text-sm text-muted-foreground">
                  <strong>{totalStepsCount - completedStepsCount} steps remaining</strong> to complete your profile
                </p>
                <Button 
                  size="sm" 
